...
from residual_sac.common.observability import define_metric_group
from residual_sac.common.observability import extract_numeric_metrics
...
DEFAULT_ROLLOUT_METRICS = (
    ...
    "reward/episode_env_return",
    "reward/episode_train_return",
    "reward/last_env_reward_sum",
    "reward/last_model_reward_sum",
    "reward/last_progress",
    "reward/last_rpc_sec",
    "reward/total_rpc_sec",
    "reward/chunks_relabelled",
    "reward/steps_relabelled",
    "reward/rpc_errors",
    "reward/fallback_chunks",
)
...
DEFAULT_REWARD_METRIC_MAPPING = (
    ("episode_env_return", "reward/episode_env_return"),
    ("episode_train_return", "reward/episode_train_return"),
    ("last_env_reward_sum", "reward/last_env_reward_sum"),
    ("last_model_reward_sum", "reward/last_model_reward_sum"),
    ("last_progress", "reward/last_progress"),
    ("last_rpc_sec", "reward/last_rpc_sec"),
    ("total_rpc_sec", "reward/total_rpc_sec"),
    ("chunks_relabelled", "reward/chunks_relabelled"),
    ("steps_relabelled", "reward/steps_relabelled"),
    ("rpc_errors", "reward/rpc_errors"),
    ("fallback_chunks", "reward/fallback_chunks"),
)
ROLLOUT_ENV_STEP_METRIC_MAPPING = (
    ...
    ("reward/episode_env_return", "reward_by_env_steps/episode_env_return"),
    ("reward/episode_train_return", "reward_by_env_steps/episode_train_return"),
    ("reward/last_env_reward_sum", "reward_by_env_steps/last_env_reward_sum"),
    ("reward/last_model_reward_sum", "reward_by_env_steps/last_model_reward_sum"),
    ("reward/last_progress", "reward_by_env_steps/last_progress"),
    ("reward/last_rpc_sec", "reward_by_env_steps/last_rpc_sec"),
    ("reward/total_rpc_sec", "reward_by_env_steps/total_rpc_sec"),
    ("reward/chunks_relabelled", "reward_by_env_steps/chunks_relabelled"),
    ("reward/steps_relabelled", "reward_by_env_steps/steps_relabelled"),
    ("reward/rpc_errors", "reward_by_env_steps/rpc_errors"),
    ("reward/fallback_chunks", "reward_by_env_steps/fallback_chunks"),
)
...
def extract_rollout_wandb_metrics(
    ...
    *,
    ...
    if isinstance(reward, Mapping):
        metrics.update(extract_numeric_metrics(reward, DEFAULT_REWARD_METRIC_MAPPING))
    return metrics
