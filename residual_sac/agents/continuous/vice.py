...
from residual_sac.agents.continuous.drq import DrQAgent
from residual_sac.agents.continuous.sac import SACAgent, _to_torch
from residual_sac.common.encoding import EncodingWrapper
from residual_sac.common.optimizers import make_optimizer
from residual_sac.networks.actor_critic_nets import Critic, CriticEnsemble, Policy
from residual_sac.networks.classifier import BinaryClassifier
from residual_sac.networks.lagrange import GeqLagrangeMultiplier
from residual_sac.networks.mlp import MLP
from residual_sac.utils.train_utils import _unpack
    ...
    def create_vice(
        ...
        **kwargs,
        ...
        if encoder_type == "small":
            from residual_sac.vision.small_encoders import SmallEncoder
            ...
            from residual_sac.vision.resnet_v1 import ResNetEncoder
