...
from residual_sac.policy.base import PolicyClient
from residual_sac.policy.base import PolicyPrefetcher
...
def build_policy_client(
    ...
    *,
    ...
    if policy_type == "openpi":
        from residual_sac.policy.openpi.client import OpenPIPolicyClient
    ...
    if policy_type == "joyra":
        from residual_sac.policy.joyra.client import JoyRAPolicyClient
...
def build_policy_prefetcher(
    ...
    *,
    ...
    action_dim = int(cfg.env.action_dim)
    if policy_type == "openpi":
        from residual_sac.policy.openpi.prefetch import AsyncOpenPIPolicyPrefetcher
    ...
    if policy_type == "joyra":
        from residual_sac.policy.joyra.prefetch import AsyncJoyRAPolicyPrefetcher
