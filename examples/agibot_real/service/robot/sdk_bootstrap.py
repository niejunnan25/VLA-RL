...
VENDOR_ROOT = AGIBOT_ROOT / "vendor" / "a2d_sdk"
WHEELS_ROOT = VENDOR_ROOT / "wheels"
SITE_ROOT = VENDOR_ROOT / "_site"
ROBOT_SERVICE_ROOT = AGIBOT_ROOT / "robot_service"
...
def ensure_repo_local_forwarder() -> Path:
    ...
    raise RuntimeError(
        ...
        "  3. a prepared examples/agibot_real/service/robot_service/forwarder directory\n"
        "  4. a local cache at examples/agibot_real/service/vendor/a2d_sdk/forwarder_x86_v1.7.0.tar.gz\n"
