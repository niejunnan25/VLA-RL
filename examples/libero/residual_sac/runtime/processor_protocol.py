...
def build_processor_submission_payload(
    *,
    ...
    residual_obs_before_chunk: dict[str, Any] | None = None,
    residual_obs_after_chunk: dict[str, Any] | None = None,
) -> dict[str, Any]:
    payload = {
    ...
    if residual_obs_before_chunk is not None:
        payload["residual_obs_before_chunk"] = dict(residual_obs_before_chunk)
    if residual_obs_after_chunk is not None:
        payload["residual_obs_after_chunk"] = dict(residual_obs_after_chunk)
    return payload
...
def reconstruct_chunk_execution_record_from_normalized(
    *,
    ...
    residual_obs_before_chunk = payload.get("residual_obs_before_chunk", {})
    residual_obs_after_chunk = payload.get("residual_obs_after_chunk", None)
    ...
    return ChunkExecutionRecord(
        ...
        residual_obs_after_chunk=(
            None if residual_obs_after_chunk is None else dict(residual_obs_after_chunk)
        ),
