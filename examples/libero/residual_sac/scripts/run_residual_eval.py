...
from residual_sac.async_eval import resolve_async_eval_checkpoint_from_index
...
from residual_sac.utils.checkpoint_utils import load_checkpoint_payload
from residual_sac.utils.checkpoint_utils import resolve_checkpoint_path
from residual_sac.utils.jsonl import JsonlWriter
...
from examples.libero.residual_sac.config import LiberoEvalConfig
from examples.libero.residual_sac.config import parse_eval_cfg
...
def _resolve_checkpoint_input(
    ...
    *,
    ...
    checkpoint_step = (
        ...
        else _nonnegative_int(checkpoint_step_raw, "eval.checkpoint_step")
    )
